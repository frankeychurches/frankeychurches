...
void Adafruit_INA219::setCalibration_32V_2A() {
  ...
  // Cal = trunc (0.04096 / (Current_LSB * RSHUNT_frank = 0.03 Ohm))
    // Cal = 13653 (0x1000)
  // Cal = 4096 (0x1000)
...
void Adafruit_INA219::setCalibration_32V_1A() {
  ...
  // MinimumLSB_frank = 0.000305             (305.18uA per bit)
  // MaximumLSB = MaxExpected_I/4096
  // MaximumLSB = 0.000244              (244uA per bit)
  // MaximumLSB = 0.00244              (2.44mA per bit)

  // 4. Choose an LSB between the min and max values
  //    (Preferrably a roundish number close to MinLSB)
  // CurrentLSB = 0.0000400 (40uA per bit)
  // CurrentLSB_frank = 0.000400 (400uA per bit)
  ...
  // Changed by me because of my Rshunt:
  ina219_calValue = 3413;
  ...
  // Max_Current_frank = 13.1068A before overflow
  //
  // If Max_Current > Max_Possible_I then
  //    Max_Current_Before_Overflow = MaxPossible_I
  // Else
  ...
  ina219_currentDivider_mA = 2.5;    // Current LSB Frank = 400uA per bit (1000/400 = 2.5)
  ina219_powerMultiplier_mW = 8.0f; // Power LSB = 800uW per bit
