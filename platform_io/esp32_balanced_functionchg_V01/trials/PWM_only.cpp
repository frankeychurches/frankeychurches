...
static const unsigned long period = 100;  //the value is a number of milliseconds
...
void setup(void)
{
  ...
  xTaskCreatePinnedToCore(  // Use xTaskCreate() in vanilla FreeRTOS
            MotorMovement,      // Function to be called
            "Motor PWM signal",   // Name of task
            1024,           // Stack size (bytes in ESP32, words in FreeRTOS)
            NULL,           // Parameter to pass
            1,              // Task priority
            NULL,           // Task handle
  ...
  xTaskCreatePinnedToCore(  // Use xTaskCreate() in vanilla FreeRTOS
            Tachometer_P,     // Function to be called
            "Tachometer Pitch",  // Name of task
            1024,           // Stack size (bytes in ESP32, words in FreeRTOS)
            NULL,           // Parameter to pass
            1,              // Task priority (must be same to prevent lockup)
            NULL,           // Task handle
  ...
  xTaskCreatePinnedToCore(  // Use xTaskCreate() in vanilla FreeRTOS
            Tachometer_Y,     // Function to be called
            "Tachometer Yaw",  // Name of task
            1024,           // Stack size (bytes in ESP32, words in FreeRTOS)
            NULL,           // Parameter to pass
            1,              // Task priority (must be same to prevent lockup)
            NULL,           // Task handle
  ...
  xTaskCreatePinnedToCore(  // Use xTaskCreate() in vanilla FreeRTOS
            Tachometer_R,     // Function to be called
            "Tachometer Roll",  // Name of task
            1024,           // Stack size (bytes in ESP32, words in FreeRTOS)
            NULL,           // Parameter to pass
            1,              // Task priority (must be same to prevent lockup)
            NULL,           // Task handle
  ...
  xTaskCreatePinnedToCore(  // Use xTaskCreate() in vanilla FreeRTOS
            RPM_data,     // Function to be called
            "RPM serial data",  // Name of task
            1024,           // Stack size (bytes in ESP32, words in FreeRTOS)
            NULL,           // Parameter to pass
            1,              // Task priority (must be same to prevent lockup)
            NULL,           // Task handle
